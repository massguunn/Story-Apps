...
class InputImageWithPreview extends LitWithoutShadowDom {
  ...
  _updatePhotoPreview() {
    const storyImgChange = document.querySelector('#validationCustomFileInputImgChange');
    const storyImgInput = document.querySelector('#validationCustomFileInput');

    let storyRecordImg = null;
    if (this.defaultImage) {
      storyRecordImg = document.querySelector('#validationCustomFileInputImg');
    }
